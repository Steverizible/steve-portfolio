...
export const projects: Project[] = [
  ...
  },
  {
    ...
    label: "AI PRODUCT STRATEGY · RESEARCH · DEVELOPMENT",
    name: "Totely",
    category: "AI Product Strategy / Growth / Development",
    year: "2025–Present",
    href: "/work/totely-ai-storage",
    selectedLabel: "Totely",
    selectedName: "AI-Native Product System",
    selectedYear: "2025–Present",
    featured: true,
    evidenceLabel: "Case Study + Evidence",
    cardDescription:
      ...
      items: [
        {
          ...
          label: "Market, Customer, Competitor and Search Validation",
          type: "methodology",
          prominence: "primary",
        },
        {
          value: "AI-Native Build",
          label: "Strategy, UX, Development and Documentation",
          type: "product",
          prominence: "secondary",
        },
        {
          value: "End-to-End System",
          label: "App, Brand, Website, SEO and Go-to-Market",
          type: "product",
          prominence: "secondary",
        },
        {
          value: "Reusable Workflows",
          label: "A Framework for Future Product Launches",
          type: "operational",
          prominence: "secondary",
        },
      ],
